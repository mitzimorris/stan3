...
help:
	@echo '--------------------------------------------------------------------------------'
	@echo 'Stan3 v$(STAN3_VERSION) help'
	@echo ''
	@echo '  Build Stan3 utilities:'
	@echo '    > $(MAKE) build'
	@echo ''
	@echo '    This target will:'
	@echo '    1. Install the Stan compiler bin/stanc$(EXE) from stanc3 binaries.'
	@echo '    2. Build all libraries and object files compile and link an executable Stan program'
	@echo ''
...
ifeq ($(OS),Windows_NT)
	...
	@echo '  Clean Stan3:'
	@echo ''
	@echo '    Remove the built Stan3 tools:'
	@echo '    > make clean-all'
	@echo ''
	@echo '--------------------------------------------------------------------------------'
...
help-dev:
	@echo '--------------------------------------------------------------------------------'
	@echo 'Stan3 help for developers:'
	@$(MAKE) print-compiler-flags
	@echo ''
	@echo '  If this copy of Stan3 has been cloned using git,'
	@echo '  before building Stan3 utilities the first time you need'
	...
	@echo '- compile_info   : prints compiler flags for compiling a Stan3 executable.'
	@echo '--------------------------------------------------------------------------------'
...
.PHONY: build
build: bin/stanc$(EXE) $(SUNDIALS_TARGETS) $(MPI_TARGETS) $(TBB_TARGETS) $(STAN3_MAIN_O) $(PRECOMPILED_MODEL_HEADER)
	@echo ''
ifeq ($(OS),Windows_NT)
	...
	@echo '--- Stan3 v$(STAN3_VERSION) built ---'
...
clean-deps:
	...
	$(RM) $(call findfiles,src,*.d) $(call findfiles,src/stan3,*.d) $(call findfiles,$(MATH)/stan,*.d) $(call findfiles,$(STAN)/src/stan3/,*.d)
	$(RM) $(call findfiles,src,*.d.*) $(call findfiles,src/stan3,*.d.*) $(call findfiles,$(MATH)/stan,*.d.*)
	$(RM) $(call findfiles,src,*.dSYM) $(call findfiles,src/stan3,*.dSYM) $(call findfiles,$(MATH)/stan,*.dSYM)
...
##
# Debug target that prints compile command for Stan3 executable
##

.PHONY: compile_info
compile_info:
	@echo '$(LINK.cpp) $(CXXFLAGS_PROGRAM) $(STAN3_MAIN_O) $(LDLIBS) $(SUNDIALS_TARGETS) $(MPI_TARGETS) $(TBB_TARGETS)'
...
$(MATH)make/% :
	...
	@echo '  $(MATH)'
	@echo ''
	@echo 'The most likely source of the problem is Stan3 was cloned without'
